...
import ruuvi_gateway.ruuvi_parser
...
class TestDataFormats(TestCase):
    ...
    def test_parse_session_cookie(self):
        ...
        cookie = ruuvi_gateway.ruuvi_parser.parse_session_cookie(header)
    ...
    def test_parse_password(self):
        ...
        password_encrypted = ruuvi_gateway.ruuvi_parser.parse_password(
